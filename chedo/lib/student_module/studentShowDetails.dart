...
class StudentShowDetails extends StatefulWidget {
  ...
  const StudentShowDetails(this.record, {Key? key}) : super(key: key);

  @override
  _StudentShowDetails createState() => _StudentShowDetails();
}
