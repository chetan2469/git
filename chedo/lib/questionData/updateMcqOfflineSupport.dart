...
class UpdateMcqOfflineSupport extends StatefulWidget {
  MCQData mcq;
  bool verified;
  GoogleSignInAccount? _currentUser;
  UpdateMcqOfflineSupport(this.mcq, this._currentUser, this.verified,
      {Key? key})
      : super(key: key);
  @override
...
class _AddEnquiryPageState extends State<UpdateMcqOfflineSupport> {
  ...
  void initState() {
    super.initState();
    question.text = widget.mcq.question;
    op1.text = widget.mcq.op1;
    op2.text = widget.mcq.op2;
    op3.text = widget.mcq.op3;
    op4.text = widget.mcq.op4;
    description.text = widget.mcq.solution;
    grp = widget.mcq.ans;
  }
